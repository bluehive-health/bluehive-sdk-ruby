    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { BlueHive::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { BlueHive::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            BlueHive::FilePart.new(value)
          in BlueHive::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in BlueHive::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [BlueHive::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: BlueHive::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in BlueHive::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in BlueHive::Internal::Type::Converter
              ...
              BlueHive::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(BlueHive::Internal::Type::Converter, T::Class[T.anything]) }
        end
