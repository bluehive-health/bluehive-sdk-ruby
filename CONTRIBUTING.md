...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/blue_hive/helpers/` and `examples/` directory.
...
require_relative "../lib/blue_hive"
...
```ruby
gem "bluehive", git: "https://www.github.com/bluehive-health/bluehive-sdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/bluehive-health/bluehive-sdk-ruby' '<path-to-repo>'
```

```ruby
gem "bluehive", path: "<path-to-repo>"
```
