...
class BlueHive::Test::SingletonClient < BlueHive::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: BlueHive::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class BlueHive::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @blue_hive = BlueHive::Test::SingletonClient.instance
  end
