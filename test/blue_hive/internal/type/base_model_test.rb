...
class BlueHive::Test::PrimitiveModelTest < Minitest::Test
  A = BlueHive::Internal::Type::ArrayOf[-> { Integer }]
  H = BlueHive::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend BlueHive::Internal::Type::Union
  end

  class B < BlueHive::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      BlueHive::Internal::Type::Unknown,
      BlueHive::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => BlueHive::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [BlueHive::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [BlueHive::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [BlueHive::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = BlueHive::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        BlueHive::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [BlueHive::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [BlueHive::Internal::Type::Boolean, true] => true,
      [BlueHive::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => BlueHive::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        BlueHive::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = BlueHive::Internal::Type::Converter.new_coerce_state
      BlueHive::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        BlueHive::Internal::Type::Converter.dump(target, input, state: state)
...
class BlueHive::Test::EnumModelTest < Minitest::Test
  class E0
    include BlueHive::Internal::Type::Enum
    attr_reader :values
...
class BlueHive::Test::CollectionModelTest < Minitest::Test
  A1 = BlueHive::Internal::Type::ArrayOf[-> { Integer }]
  H1 = BlueHive::Internal::Type::HashOf[Integer]

  A2 = BlueHive::Internal::Type::ArrayOf[H1]
  H2 = BlueHive::Internal::Type::HashOf[-> { A1 }]

  A3 = BlueHive::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = BlueHive::Internal::Type::HashOf[Integer, nil?: true]
...
class BlueHive::Test::BaseModelTest < Minitest::Test
  class M1 < BlueHive::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < BlueHive::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < BlueHive::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, BlueHive::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = BlueHive::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = BlueHive::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(BlueHive::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue BlueHive::Errors::ConversionError => e
...
class BlueHive::Test::UnionTest < Minitest::Test
  class U0
    include BlueHive::Internal::Type::Union
  ...
  class M2 < BlueHive::Internal::Type::BaseModel
  ...
  class M4 < BlueHive::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, BlueHive::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < BlueHive::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, BlueHive::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class BlueHive::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include BlueHive::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [BlueHive::Internal::Type::Unknown, BlueHive::Internal::Type::Unknown] => true,
      [BlueHive::Internal::Type::Boolean, BlueHive::Internal::Type::Boolean] => true,
      [BlueHive::Internal::Type::Unknown, BlueHive::Internal::Type::Boolean] => false,
...
class BlueHive::Test::MetaInfoTest < Minitest::Test
  A1 = BlueHive::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = BlueHive::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
