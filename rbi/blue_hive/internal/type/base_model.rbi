    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  BlueHive::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  BlueHive::Internal::Type::BaseModel::KnownField,
                  { type: BlueHive::Internal::Type::Converter::Input }
                )
              ]
            )
          end
          ...
          sig do
            params(
                ...
                T.any(
                  {
                    ...
                    enum:
                      T.nilable(
                        T.proc.returns(
                          BlueHive::Internal::Type::Converter::Input
                        )
                      ),
                    union:
                      T.nilable(
              ...
              spec: BlueHive::Internal::AnyHash
            ).void
          end
          ...
          sig do
            override
              .params(
                ...
                state: BlueHive::Internal::Type::Converter::CoerceState
              )
          ...
          sig do
            override
              .params(
                ...
                state: BlueHive::Internal::Type::Converter::DumpState
              )
        ...
        class << self
          ...
          sig do
            params(
              model: BlueHive::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(BlueHive::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(BlueHive::Internal::AnyHash) }
        def to_h
        end
